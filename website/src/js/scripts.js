...
function initMap() {
	var myLatlng = new google.maps.LatLng(45.4245412, -75.6886602); // <- Your latitude and longitude
	var styles = [
		{
			"featureType": "water",
			"stylers": [{
...
/**
 * Function used to get the form data and submit it to slack
 */
function getFormData() {
	...
	return { "text": "name=" + name + "&email=" + email + "&message=" + message };
}

/**
 * Function to get the Slack URL
 */
function getURL() {
	return atob('aHR0cHM6Ly9ob29rcy5zbGFjay5jb20vc2VydmljZXMvVDlCRlFVNEdIL0JSR0dRUkI1TS9oSDJsaGxrZFpTbjJ0TFQ3d3Z5VklieUk=');
}